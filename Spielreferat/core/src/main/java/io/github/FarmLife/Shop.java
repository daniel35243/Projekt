...
public class Shop {
    ...
    private void initFontStyle() {
        ...
        Drawable buttonUpN = new TextureRegionDrawable(buttonUpTex);
        Drawable buttonDownN = new TextureRegionDrawable(buttonDownTex);

        BigStyle = new TextButton.TextButtonStyle();
        BigStyle.font = buttonFont;
        BigStyle.up = buttonUpN;
        BigStyle.down = buttonDownN;
    ...
    public void render(Rectangle rec, Vector2 pos) {
        ...
        sleepButtonStage.act(Gdx.graphics.getDeltaTime()); // Aktualisiert den SleepButton
        sleepButtonStage.draw(); // Zeichnet SleepButton
        uiStage.act(Gdx.graphics.getDeltaTime()); // Aktualisiert die Windows und Bilder
        uiStage.draw(); // Zeichnet die Windows und Bilder
    }
    private void showMainMenu(InventorySlot[] inventory, Player player) {
        ...
        Table content = new Table(); // Tabelle die als UI-Container dient
        content.pad(10);
