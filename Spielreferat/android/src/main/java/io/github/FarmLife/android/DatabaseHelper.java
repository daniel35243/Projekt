...
public class DatabaseHelper extends SQLiteOpenHelper {
    private static final String DB_NAME = "Datenbank.db"; // Name der Datenbank
    private static final int DB_VERSION = 1; // Version der Datenbank für Automatische Upgrades
    private SQLiteDatabase db; // Datenbank Instanz
    public DatabaseHelper(Context context) {
        super(context, DB_NAME, null, DB_VERSION); // App Kontext, Dateiname, Standart Cursor Factory, Version
        db = getWritableDatabase();
    }

    @Override
    public void onCreate(SQLiteDatabase db) { // wird ausgeführt, wwenn die Datenbank noch nicht existiert
        // TABLE
        ...
        db.execSQL("INSERT INTO Felder (feldID, item, Wachsstufe, feld_x, feld_y) VALUES (10, NULL, NULL, 608, 656)");
        db.execSQL("INSERT INTO Felder (feldID, item, Wachsstufe, feld_x, feld_y) VALUES (11, NULL, NULL, 672, 656)");
        db.execSQL("INSERT INTO Felder (feldID, item, Wachsstufe, feld_x, feld_y) VALUES (12, NULL, NULL, 736, 656)");
        db.execSQL("INSERT INTO Felder (feldID, item, Wachsstufe, feld_x, feld_y) VALUES (13, NULL, NULL, 736, 592)");
        db.execSQL("INSERT INTO Felder (feldID, item, Wachsstufe, feld_x, feld_y) VALUES (14, NULL, NULL, 672, 592)");
        db.execSQL("INSERT INTO Felder (feldID, item, Wachsstufe, feld_x, feld_y) VALUES (15, NULL, NULL, 736, 592)");
    }

    @Override
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) { // Wenn Version geändert wird
